...
class Display():
    def __init__(self,root):
        ...
        self.root.title("Patient Record Display")
        self.style = Style()
    ...
    def display(self):
        ...
        mydb.close()        
        tree = Treeview(self.root,height = 20, column=("c1", "c2", "c3","c4","c5","c6","c7","c8"), show='headings')
        ...
        tree.heading("#4", text="Alternate Mobile No")
        ...
        hsb.place(x=150, y=428,width=700)
