...
class record():
    ...
    def page(self):
        ...
        self.cb = IntVar()
        self.Combo = Combobox(self.root,textvariable=self.cb,width=12, values = ('Patient Name','Mobile','Patient Id'))
        #self.Combo.grid()
